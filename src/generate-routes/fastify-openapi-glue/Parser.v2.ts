...
export class ParserV2 extends ParserBase {
    ...
    parseParameters(schema: any, data: any[]): void {
        const params: any[] = []
    ...
    processOperation(path: string, operation: string, data: any): void {
        const route: any = {
            ...
            openapiPath: path,
            operationId:
                data.operationId || this.makeOperationId(operation, path),
            openapiSource: data,
